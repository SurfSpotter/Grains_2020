...
class Model: NSObject {
    ...
    let oatmeal = Grain(name: "Геркулес",
                        ...
                        protein: 13,
                        caloriesInCcal: 370,
                        description: "1. Засыпать в кипящую воду. \n2. Варить на медленном огне, периодически помешивая",
                        imageName: "herkuless",
                        backGroundColorRed: 1 ,
                        backGroundColorGreen: 1,
                        backGroundColorBlue: 1,
    ...
    let goroh = Grain(name: "Горох",
                    ...
                    caloriesInCcal: 320.0,
                            ...
                            description: "1. Заранее замочить. \n2. Хорошо промыть.  \n3. Залить холодной водой и варить на медленном огне перирдически помешивая. ",
                    imageName: "goroh" ,
    ...
    let dolichos = Grain(name: "Долихос",
                        ...
                        protein: 21,
                        caloriesInCcal: 329,
                        description: "1. Замочите на 8-10 часов в большом количестве холодной воды. /n2. Промыть. /n3. Залить крутым кипятком, варить без крышки на слабом огне.",
                        imageName: "dolichos",
                        backGroundColorRed: 157 ,
                        backGroundColorGreen: 105,
                        backGroundColorBlue: 47,
    ...
    let oatmealNo1 = Grain(name: "Овсяные хлопья №1",
                        ...
                        protein: 13 ,
                        caloriesInCcal: 380,
                        description: "1. Засыпьте в кипящую воду или молоко. \n2. Варите на медленном огне. \n3. Снимите с огня, дайте постоять под крышкой 2-3 минуты.",
    ...
    let polba = Grain(name: "Полба",
       ...
       protein: 14.7 ,
       caloriesInCcal: 323,
       description: "1. Замочите на 1 час в большом количестве воды. \n2. Полбу перед варкой промывают, замачивают в холодной воде на час для большей мягкости, заливают в просторной кастрюле холодной водой и варят на тихом огне под крышкой.",
       imageName: "polba",
       backGroundColorRed: 157 ,
       backGroundColorGreen: 105,
       backGroundColorBlue: 47,
    ...
    protein: 7.6,
    caloriesInCcal: 340,
    description: "1. Промойте водой \n2. Залейте холодной водой и варите на медленнм огне. \n3. Не мешайте.\n4. Если вода выпарилась, а рис суховат - необходимо добавить кипятка, затем варить рис ещё 3-4 минуты. ",
    ...
    protein: 10,
    caloriesInCcal: 324,
    description: "1.Залейте холдной водой и доведите до кипения. \n2. Варите регулярно перемешивая. \n3. После варки дайте постоять под крышкой 10 минут.",
